...
export function OTPEmailTemplate({ name, code }: { name: string; code: string }): string {
  return emailWrapper(`
    ...
    <div class="code-box">
      ...
      <p style="font-size:13px; color:#64748b; margin-top:12px; margin-bottom:0;">Expires in 10 minutes</p>
    </div>

    <p style="font-size:13px; color:#64748b;">Didn't request this? You can safely ignore this email.</p>
  `);
}

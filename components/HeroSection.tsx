  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div
        ...
        style={{ background: "rgba(59,130,246,0.12)", animationDelay: "0s" }}
      />
      <div
        className="orb w-80 h-80 top-40 right-0"
        style={{ background: "rgba(99,102,241,0.1)", animationDelay: "2s" }}
      />
      <div
        className="orb w-64 h-64 bottom-20 left-1/3"
        style={{ background: "rgba(59,130,246,0.08)", animationDelay: "4s" }}
      />

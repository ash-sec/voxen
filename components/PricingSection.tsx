  ...
  return (
    <section id="pricing" className="py-24 px-6">
      <div ref={sectionRef} className="section-hidden max-w-2xl mx-auto text-center">
        ...
        <div
          className="p-px rounded-2xl shadow-2xl shadow-blue-500/20"
          style={{ background: "linear-gradient(135deg, rgba(59,130,246,0.6) 0%, rgba(99,102,241,0.3) 100%)" }}
        >
          <div
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <span className="ml-2 inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-500/15 text-blue-400 border border-blue-500/20">
                  Most Popular
                </span>
              </div>
            ...
            <ul className="space-y-3 mb-8">
              {features.map((f, i) => (
                <li key={i} className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 bg-green-500/15 border border-green-500/25">

...
const mdxComponents = {
  ...
  p: (props: React.HTMLAttributes<HTMLParagraphElement>) => (
    <p className="text-[#d4d4d4] leading-relaxed mb-5 text-base" {...props} />
  ),
  ul: (props: React.HTMLAttributes<HTMLUListElement>) => (
    <ul className="list-disc list-outside pl-6 text-[#d4d4d4] mb-5 space-y-2" {...props} />
  ),
  ol: (props: React.OlHTMLAttributes<HTMLOListElement>) => (
    <ol className="list-decimal list-outside pl-6 text-[#d4d4d4] mb-5 space-y-2" {...props} />
  ),
  li: (props: React.HTMLAttributes<HTMLLIElement>) => (
    <li className="text-[#d4d4d4] leading-relaxed text-base" {...props} />
  ),
  a: (props: React.AnchorHTMLAttributes<HTMLAnchorElement>) => (
    <a
      className="text-[#3b82f6] hover:text-white underline underline-offset-2 transition-[color] duration-200"
      {...props}
    />
  ),
  ...
  em: (props: React.HTMLAttributes<HTMLElement>) => (
    <em className="text-[#d4d4d4] italic" {...props} />
  ),
  blockquote: (props: React.HTMLAttributes<HTMLQuoteElement>) => (
    <blockquote
      className="border-l-4 border-blue-500/60 pl-5 my-6 text-[#a1a1aa] italic"
      {...props}
    />
  ),
  hr: () => (
      ...
      <main className="min-h-screen bg-black">
        ...
        <section className="pt-32 pb-12 px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <Link
              href="/blog"
              className="inline-flex items-center gap-2 text-[#a1a1aa] hover:text-white text-sm transition-[color] duration-200 mb-10 group"
            >
              <svg
            ...
            <time
              ...
              className="text-xs font-medium text-[#52525b] uppercase tracking-wider mb-4 block"
            >
            ...
            {/* Author/meta bar */}
            <div className="flex items-center gap-3 pb-10 border-b border-white/[0.08]">
              ...
              <div>
                ...
                <p className="text-xs text-[#52525b]">Voxen Blog</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 pb-24">
          <div className="max-w-3xl mx-auto">
            <div className="glass-card p-8 md:p-12 text-center">
              ...
              <p className="text-[#a1a1aa] mb-8 max-w-xl mx-auto leading-relaxed">

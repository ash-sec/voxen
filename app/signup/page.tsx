...
export default function SignupPage() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="orb w-72 h-72 bottom-10 -left-20 pointer-events-none"
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {step === "details" ? (
          <div className="glass-card p-8">
            ...
            <p className="text-slate-400 text-sm mb-8">
              Create your account in 2 minutes. No card required yet.
            </p>
        ...
        <div className="mt-6 flex items-center justify-center gap-6 text-xs text-slate-600">
          <div className="flex items-center gap-1.5">
            <svg className="w-3.5 h-3.5 text-blue-500/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
